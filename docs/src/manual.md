...
EzXMLPatched.Document(EzXMLPatched.Node(<DOCUMENT_NODE@0x00007fd9f1f14370>))

julia> typeof(doc)
EzXMLPatched.Document

julia> doc.node
EzXMLPatched.Node(<DOCUMENT_NODE@0x00007fd9f1f14370>)
...
EzXMLPatched.Node(<ELEMENT_NODE[root]@0x00007fd9f2a1b5f0>)
...
EzXMLPatched.Node(<TEXT_NODE@0x00007fd9f2a81ee0>)
...
EzXMLPatched.Node(<ELEMENT_NODE[element]@0x00007fd9f44122f0>)
...
EzXMLPatched.Node(<TEXT_NODE@0x00007fd9f441f3f0>)
...
EzXMLPatched.Node(<ELEMENT_NODE[User]@0x00007fd9f427c510>)

julia> println(user)
<User/>

julia> addelement!(user, "id", "167492")
EzXMLPatched.Node(<ELEMENT_NODE[id]@0x00007fd9f41ad580>)

julia> println(user)
<User><id>167492</id></User>

julia> addelement!(user, "name", "Kumiko Oumae")
EzXMLPatched.Node(<ELEMENT_NODE[name]@0x00007fd9f42942d0>)
...
EzXMLPatched.Document(EzXMLPatched.Node(<DOCUMENT_NODE@0x00007fd9f410a5f0>))

julia> data = String(read("primates.xml"));

julia> doc = parsexml(data)
EzXMLPatched.Document(EzXMLPatched.Node(<DOCUMENT_NODE@0x00007fd9f4051f80>))
...
EzXMLPatched.Node(<ELEMENT_NODE[primates]@0x00007fd9f4086880>)

julia> genus = elements(primates)  # `elements` returns all child elements.
2-element Array{EzXMLPatched.Node,1}:
 EzXMLPatched.Node(<ELEMENT_NODE[genus]@0x00007fd9f4041a40>)
 EzXMLPatched.Node(<ELEMENT_NODE[genus]@0x00007fd9f40828e0>)
...
EzXMLPatched.Node(<TEXT_NODE@0x00007fd9f409f200>)
...
EzXMLPatched.Node(<TEXT_NODE@0x00007fd9f404bec0>)
...
node = EzXMLPatched.Node(<TEXT_NODE@0x00007fd9f409f200>)
node = EzXMLPatched.Node(<ELEMENT_NODE[genus]@0x00007fd9f4041a40>)
node = EzXMLPatched.Node(<TEXT_NODE@0x00007fd9f4060f70>)
node = EzXMLPatched.Node(<ELEMENT_NODE[genus]@0x00007fd9f40828e0>)
node = EzXMLPatched.Node(<TEXT_NODE@0x00007fd9f404bec0>)
...
5-element Array{EzXMLPatched.Node,1}:
 EzXMLPatched.Node(<TEXT_NODE@0x00007fd9f409f200>)
 EzXMLPatched.Node(<ELEMENT_NODE[genus]@0x00007fd9f4041a40>)
 EzXMLPatched.Node(<TEXT_NODE@0x00007fd9f4060f70>)
 EzXMLPatched.Node(<ELEMENT_NODE[genus]@0x00007fd9f40828e0>)
 EzXMLPatched.Node(<TEXT_NODE@0x00007fd9f404bec0>)
...
EzXMLPatched.Document(EzXMLPatched.Node(<DOCUMENT_NODE@0x00007fbeddc2a1d0>))

julia> findall("/primates", primates)  # Find the "primates" element just under the document
1-element Array{EzXMLPatched.Node,1}:
 EzXMLPatched.Node(<ELEMENT_NODE[primates]@0x00007fbeddc1e190>)

julia> findall("//genus", primates)
2-element Array{EzXMLPatched.Node,1}:
 EzXMLPatched.Node(<ELEMENT_NODE[genus]@0x00007fbeddc12c50>)
 EzXMLPatched.Node(<ELEMENT_NODE[genus]@0x00007fbeddc16ea0>)
...
julia> doc = parsexml("""
       ...
       """)
EzXMLPatched.Document(EzXMLPatched.Node(<DOCUMENT_NODE@0x00007fdc67710030>))
...
1-element Array{EzXMLPatched.Node,1}:
 EzXMLPatched.Node(<ELEMENT_NODE[child]@0x00007fdc6774c990>)
...
EzXMLPatched.StreamReader(<READER_NONE@0x00007f9fe8d67340>)
...
```jldoctest
julia> reader = open(EzXMLPatched.StreamReader, "undirected.graphml")
EzXMLPatched.StreamReader(<READER_NONE@0x00007fd642e80d90>)
...
```jldoctest
julia> reader = open(EzXMLPatched.StreamReader, "undirected.graphml")
EzXMLPatched.StreamReader(<READER_NONE@0x00007fd642e9a6b0>)
